    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-md bg-cta-blue px-4 py-2 text-sm font-medium text-white transition hover:brightness-110"
          >
            Ir para o início
          </Link>
        </div>
      ...
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          <button
            ...
            className="inline-flex items-center justify-center rounded-md bg-cta-blue px-4 py-2 text-sm font-medium text-white"
          >
            Tentar novamente
          </button>
          <a
